                        ...
                        <div class="comment-line px-0 pt-3 mt-3">
                            <div class="comment-list">
                                ...
                                {{-- <div class="row col-12 d-flex p-0 m-0 mt-3 comment-hide comment-item1">
                                    <div class="d-flex col-2 justify-content-center col-2 col-md-1 ">
                                        <img class="avatar-student-smaller"
                                            src="{{ URL::to(config('asset.images_path') . '8.png') }}" alt="">
                                    </div>
                                    <div class="my-auto col-10 p-1">
                                        <div class="d-flex">
                                ...
                                <div class="row col-12 d-flex p-0 m-0 mt-3 comment-hide comment-item1">
                                    <div class="d-flex col-2 justify-content-center col-2 col-md-1 ">
                                        <img class="avatar-student-smaller"
                                            src="{{ URL::to(config('asset.images_path') . '2.png') }}" alt="">
                                    </div>
                                    <div class="my-auto col-10 p-1">
                                        <div class="d-flex">
                                            <h6 class="small-text"><b>Nguyễn Thị Tuyết Nhật</b></h6>
                                ...
                                <div class="row col-12 d-flex p-0 m-0 mt-3 comment-hide comment-item1">
                                    <div class="d-flex col-2 justify-content-center col-2 col-md-1 ">
                                        <img class="avatar-student-smaller"
                                            src="{{ URL::to(config('asset.images_path') . '3.png') }}" alt="">
                                    </div>
                                    <div class="my-auto col-10 p-1">
                                        <div class="d-flex">
                                            <h6 class="small-text"><b>Nguyễn Thị Tuyết Nhật</b></h6>
                                ...
                                <div class="row col-12 d-flex p-0 m-0 mt-3 comment-hide comment-item1">
                                    <div class="d-flex col-2 justify-content-center col-2 col-md-1 ">
                                        <img class="avatar-student-smaller"
                                            src="{{ URL::to(config('asset.images_path') . '4.png') }}" alt="">
                                    </div>
                                    <div class="my-auto col-10 p-1">
                                        <div class="d-flex">
                                            <h6 class="small-text"><b>Nguyễn Thị Tuyết Nhật</b></h6>
