					...
					<div class="panel-body">
						<div class="content-row px-5">
							<div class="ppcolumn pt-4">
								<a href="display3f7b.html?url=data/Welcome_to_Python.pdf&amp;title=Welcome%20to%20Python!%20/%20Introduction%20to%20Python&amp;subject=PYTHON&amp;durl=data/Welcome_to_Python.pptx"
									class="appt">Xem chi tiết</a>
								<img src="{{URL::to(config('asset.images_path').'p-img.png')}}" style="padding-bottom:5px;" />
								<h3 style="word-wrap: break-word;">Bài Giảng 1</h3>
							</div>
							<div class="ppcolumn pt-4">
